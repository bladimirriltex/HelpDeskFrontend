...
.hero-container .quick-links .card-head {
...
.hero-container .quick-links .card-content {
  color: #fff;
  font-size: 1.6rem;
  padding: 10px 32px;
  font-weight: bold;
...
.contact-support .contacts .card-contact {
  width: 300px;
  border-radius: 3px;
...
.contact-support .contacts .card-contact h2 {
  margin-top: 6px;
  opacity: 1;
  font-size: 2.1rem;
  line-height: 2.3rem;
